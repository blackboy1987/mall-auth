...
import com.bootx.mall.common.BaseAttributeConverter;
...
import com.bootx.mall.plugin.GiftPromotionPlugin.GiftAttribute;
...
public class Sku extends BaseEntity<Long> {
	 ...
	 */
	@Transient
	public com.bootx.mall.entity.Store getStore() {
	 ...
	 */
	@Transient
	public BigDecimal getPlatformCommission(com.bootx.mall.entity.Store.Type type) {
		...
		if (type != null && getProduct() != null && getProduct().getProductCategory() != null) {
			...
			if (com.bootx.mall.entity.Store.Type.GENERAL.equals(type) && productCategory.getGeneralRate() > 0) {
				commission = getPrice().multiply(new BigDecimal(String.valueOf(productCategory.getGeneralRate())).movePointLeft(2));
			} else if (com.bootx.mall.entity.Store.Type.SELF.equals(type) && productCategory.getSelfRate() > 0) {

...
import com.bootx.mall.dao.OrderLogDao;
import com.bootx.mall.dao.OrderPaymentDao;
import com.bootx.mall.dao.OrderRefundsDao;
import com.bootx.mall.dao.OrderReturnsDao;
import com.bootx.mall.dao.OrderShippingDao;
...
import com.bootx.mall.entity.OrderLog;
...
import com.bootx.mall.entity.OrderShippingItem;
...
import com.bootx.mall.service.MailService;
...
import com.bootx.mall.service.SmsService;
...
public class OrderServiceImpl extends BaseServiceImpl<Order, Long> implements OrderService {
	...
	public List<Order> findList(Order.Type type, Order.Status status, Store store, Member member, Product product, Boolean isPendingReceive, Boolean isPendingRefunds, Boolean isUseCouponCode, Boolean isExchangePoint, Boolean isAllocatedStock, Boolean hasExpired, Integer count, List<Filter> filters,
                                List<com.bootx.mall.common.Order> orders) {

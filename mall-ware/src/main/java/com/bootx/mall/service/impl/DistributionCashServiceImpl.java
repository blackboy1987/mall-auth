...
import com.bootx.mall.dao.DistributionCashDao;
import com.bootx.mall.dao.DistributorDao;
...
public class DistributionCashServiceImpl extends BaseServiceImpl<DistributionCash, Long> implements DistributionCashService {
	...
	@Override
	@Transactional(readOnly = true)
	public Long count(DistributionCash.Status status, String bank, String account, String accountHolder, Long distributorId) {

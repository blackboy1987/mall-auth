...
import com.bootx.mall.auth.entity.vo.SkuVo;
import com.bootx.mall.auth.exception.ResourceNotFoundException;
import com.bootx.mall.auth.feign.SearchService;
import com.bootx.mall.auth.service.*;
...
public class ProductController extends BaseController {
	...
	public String search(String keyword, Store.Type storeType, Long storeId, Boolean isOutOfStock, BigDecimal startPrice, BigDecimal endPrice, Product.OrderType orderType, Integer pageNumber, Integer pageSize, ModelMap model) {
		...
		Page<SkuVo> page = searchService.search(keyword, null, storeType, storeId, isOutOfStock, null, startPrice, endPrice, orderType, pageNumber,pageSize);

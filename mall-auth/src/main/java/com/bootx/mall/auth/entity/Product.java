...
import com.bootx.mall.auth.common.BigDecimalNumericFieldBridge;
...
public class Product extends BaseEntity<Long> {
	...
	private com.bootx.mall.auth.entity.Store store;
	 ...
	 *            店铺
	 */
	public void setStore(com.bootx.mall.auth.entity.Store store) {
		this.store = store;
	}

...
public interface ProductCategoryService extends BaseService<ProductCategory, Long> {
    ...
    List<ProductCategoryTreeVo> findRootsVo(Integer count, boolean useCache);

	List<ProductCategoryTreeVo> findParentsVo(Long productCategoryId, boolean b, Integer count, boolean useCache);

	List<ProductCategoryTreeVo> findChildrenVo(Long productCategoryId, boolean b, Integer count, boolean useCache);
}
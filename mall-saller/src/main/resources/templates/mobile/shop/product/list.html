...
<head>
	...
	<meta name="author" content="好源++ Team">
	<meta name="copyright" content="好源++">
	[#if productCategory??]
		[@seo type = "PRODUCT_LIST"]
			...
			[/#if]
			<title>[#if productCategory.seoTitle?has_content]${productCategory.seoTitle}[#else]${seo.resolveTitle()}[/#if][#if showPowered] - 好源网++[/#if]</title>
		[/@seo]
	[#else]
		<title>${message("shop.product.list")}[#if showPowered] - 好源网++[/#if]</title>
	[/#if]

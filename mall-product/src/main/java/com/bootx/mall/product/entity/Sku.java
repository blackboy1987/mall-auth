...
package com.bootx.mall.product.entity;
...
import com.bootx.mall.product.common.BaseAttributeConverter;
...
import com.bootx.mall.product.plugin.GiftPromotionPlugin.GiftAttribute;
...
public class Sku extends BaseEntity<Long> {
	 ...
	 */
	@Transient
	public com.bootx.mall.product.entity.Store getStore() {
	 ...
	 */
	@Transient
	public BigDecimal getPlatformCommission(com.bootx.mall.product.entity.Store.Type type) {
		...
		if (type != null && getProduct() != null && getProduct().getProductCategory() != null) {
			...
			if (com.bootx.mall.product.entity.Store.Type.GENERAL.equals(type) && productCategory.getGeneralRate() > 0) {
				commission = getPrice().multiply(new BigDecimal(String.valueOf(productCategory.getGeneralRate())).movePointLeft(2));
			} else if (com.bootx.mall.product.entity.Store.Type.SELF.equals(type) && productCategory.getSelfRate() > 0) {

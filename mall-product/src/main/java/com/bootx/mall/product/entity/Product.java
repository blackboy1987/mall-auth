...
import com.bootx.mall.product.common.BigDecimalNumericFieldBridge;
...
public class Product extends BaseEntity<Long> {
	...
	private com.bootx.mall.product.entity.Store store;
	 ...
	 *            店铺
	 */
	public void setStore(com.bootx.mall.product.entity.Store store) {
		this.store = store;
	}
